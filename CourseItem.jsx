...
const CourseItem = (props) => {
  ...
  return (
    <div className=" bg-emerald-100 h-full flex my-4 mx-4 p-20 text-center items-center justify-center">
    <div className="my-8 mx-20">
      <h3  className="text-green-950">Find the right tutor for you</h3>
      <button onClick={() => gotToNewPage()} className=" my-8 hover:text-emerald-100 hover:bg-emerald-500 text-green-700 font-semibold py-2 px-4 border border-black hover:border-transparent rounded">Get Started</button>
      </div>
      <div className="my-8 mx-20">
      <img src={tutor}></img>
      </div>
